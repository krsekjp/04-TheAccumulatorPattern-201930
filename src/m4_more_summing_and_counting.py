...
def run_test_factorial():
    ...
    # Test 4:
    answer_from_oracle = math.factorial(88)
    answer_from_my_code = factorial(88)
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 3
    answer = count_cosines_from(0, 2, -0.42)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 2
    answer = count_cosines_from(0, 2, 0)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 1
    answer = count_cosines_from(0, 2, 0.67)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 1
    answer = count_cosines_from(9, 11, 0)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 2
    answer = count_cosines_from(9,11, -0.85)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 1.83333  # This is APPROXIMATELY the correct answer.
